...
> **取其精华，去其糟粕**：深度融合 `writing-dna-skill` 的 **6 层名家文风蒸馏方法论** 与 `oh-story-claudecode` 的 **商业网文工业化架构（大纲/正文/去AI/审稿/封面/老书接续）**，打造让 AI 兼具“商业爽点骨架”与“名家文风灵魂”的新一代小说创作引擎。

---

## 一、 为什么做这个整合？（取精华 · 弃糟粕）

| 来源项目 | 汲取的【精华】 | 剔除的【糟粕/冗余】 |
| :--- | :--- | :--- |
| **`writing-dna-skill`** | 6 层文风深度蒸馏体系（L1 句长呼吸感 ~ L5 认知模型）、前置 5 篇原文语感校准机制、文风豁免权原则、信息守恒铁律。 | 缺乏长篇网文的大纲伏笔系统、无商业平台市场洞察、单篇生成易在长篇中失控。 |
| **`oh-story-claudecode`** | 起点/番茄/知乎商业网文大纲法、黄金三章节奏、7-Gate 网文去 AI 味、4 视角审稿体系、三层上下文架构、**对白权力博弈法则、六大情绪弧线、老书逆向接续、平台封面设计**。 | 13 个 Skill 分散繁琐、自带文风偏平庸通识腔、跨平台 Hook/CLI 依赖较重。 |
